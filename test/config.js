...
const dbName = () => {
  ...
  return `test-${currentDate.getTime()}-${currentDate.getMilliseconds()}.fdb`;
};
...
exports.uniqueDb = (args = {}) => {
  return Object.assign({}, exports.default, {
    database: path.join(testDir, dbName()),
    ...args,
  });
};
