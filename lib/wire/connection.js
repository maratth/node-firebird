...
function createBatchParam(value, sqlvar) {
    const sqlType = sqlvar.type & ~1; // strip nullable bit
    ...
    switch (sqlType) {
        ...
        case Const.SQL_NULL:
        case Const.SQL_VARYING:
            return new Xsql.SQLParamString(v, sqlType, sqlvar.length || 0);
        case Const.SQL_FLOAT:
            return new Xsql.SQLParamDouble(v != null ? Number(v) : null, Const.SQL_FLOAT);
        case Const.SQL_DOUBLE:
        case Const.SQL_D_FLOAT:
            return new Xsql.SQLParamDouble(v != null ? Number(v) : null, sqlType);
        case Const.SQL_TYPE_DATE:
        case Const.SQL_TYPE_TIME:
        case Const.SQL_TIMESTAMP:
        case Const.SQL_TIME_TZ:
        ...
        case Const.SQL_TIMESTAMP_TZ_EX: {
            let d = null;
            if (v != null) {
                d = v instanceof Date ? v : typeof v === 'string' ? parseDate(v) : new Date(v);
            }
            return new Xsql.SQLParamDate(d, sqlType);
        }
        case Const.SQL_BLOB:
        case Const.SQL_ARRAY:
        case Const.SQL_QUAD:
            return new Xsql.SQLParamQuad(v);
        case Const.SQL_LONG:
        case Const.SQL_SHORT:
            return new Xsql.SQLParamInt(v);
        case Const.SQL_INT64:
            return new Xsql.SQLParamInt64(v);
        case Const.SQL_BOOLEAN:
            return new Xsql.SQLParamBool(v);
        case Const.SQL_INT128:
            return new Xsql.SQLParamInt128(v);
        case Const.SQL_DEC16:
            return new Xsql.SQLParamDecFloat16(v);
        case Const.SQL_DEC34:
            return new Xsql.SQLParamDecFloat34(v);
        default:
            throw new Error('Unsupported SQL type in batch: ' + sqlType);
    }
}

function encodeBatchField(msg, value, meta) {
    const param = createBatchParam(value, meta);
    param.encode(msg, true);
    if (param.value !== null) {
        msg.addInt(0);
    }
}
...
module.exports.createBatchParam = createBatchParam;
